...
Limited functionality and future fixes:
Currently can only add films from a local database of 30 films (the posters of which are the major memory burden). Requests to The Movie Database will be implemented.
